#!/bin/bash
# MOD of AutoBuild Module by Hyy2001 <https://github.com/Hyy2001X/AutoBuild-Actions>
...
[[ ! -d ${Main_tmp} ]] && mkdir -p "${Main_tmp}"
Github_Raw="https://ghproxy.com/https://raw.githubusercontent.com/iboosting/Lean-AutoBuild/master"
AutoBuild_Tools
